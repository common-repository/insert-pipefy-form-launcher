...
<div class="ipfl-chat-full-page" id="ipfl-myForm-full">
  <div class="ipfl-form-container-full-page">
    <div id="ipfl-fullpage-iframe" style="width:100%;">
        <div class="ipfl-full-page-install">
            ...
            <g>
                <path d="M10,16H5V5h14v6c0,0.6,0.4,1,1,1s1-0.4,1-1V5c0-1.1-0.9-2-2-2H5C3.9,3,3,3.9,3,5v11c0,1.1,0.9,2,2,2h5c0.6,0,1-0.4,1-1
                    C11,16.4,10.6,16,10,16z"/>
                <path d="M17,8c0-0.6-0.4-1-1-1H8C7.4,7,7,7.4,7,8s0.4,1,1,1h8C16.6,9,17,8.6,17,8z"/>
                <path d="M8,11c-0.6,0-1,0.4-1,1s0.4,1,1,1h4c0.6,0,1-0.4,1-1s-0.4-1-1-1H8z"/>
                <path d="M21,16h-1.2c0-0.1-0.1-0.2-0.1-0.3l0.8-0.8c0.4-0.4,0.4-1,0-1.4s-1-0.4-1.4,0l-0.8,0.8c-0.1,0-0.2-0.1-0.3-0.1V13
                    c0-0.6-0.4-1-1-1s-1,0.4-1,1v1.2c-0.1,0-0.2,0.1-0.3,0.1l-0.8-0.8c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4l0.8,0.8
                    c0,0.1-0.1,0.2-0.1,0.3H13c-0.6,0-1,0.4-1,1s0.4,1,1,1h1.2c0,0.1,0.1,0.2,0.1,0.3l-0.8,0.8c-0.4,0.4-0.4,1,0,1.4
                    c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3l0.8-0.8c0.1,0,0.2,0.1,0.3,0.1V21c0,0.6,0.4,1,1,1s1-0.4,1-1v-1.2c0.1,0,0.2-0.1,0.3-0.1
                    l0.8,0.8c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3c0.4-0.4,0.4-1,0-1.4l-0.8-0.8c0-0.1,0.1-0.2,0.1-0.3H21c0.6,0,1-0.4,1-1
                    S21.6,16,21,16z M17,18c-0.6,0-1-0.4-1-1c0-0.6,0.4-1,1-1s1,0.4,1,1C18,17.6,17.6,18,17,18z"/>
            </g>
            </svg>
            <strong>Plugin installed!</strong>
            <br>
            Now go to your WordPress Panel Tools and insert the public form code from your pipe.
        </div>
    </p>
    </div>
  </div>
...
<div id="ipfl-bg-full-page-id" class="ipfl-bg-full-page-empty"></div>
