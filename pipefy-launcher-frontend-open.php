...
<div style="background-color:<?php esc_html_e( $colorVar, 'colorVar' ) ?> !important;" class="ipfl-close-button" id="ipfl-closeButton" onclick="ipflCloseForm()">
  <svg version="1.1" id="Layer_2_1_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve">
...
<div class="ipfl-chat-popup" id="ipfl-myForm">
  <div class="ipfl-form-container">
    <iframe width="100%" height="100%" style="width:100% !important;" src="https://app.pipefy.com/public/form/<?php esc_html_e( $formVar, 'formVar' ) ?>?embedded=true" frameborder="0"></iframe>
  </div>
</div>

<div id="ipfl-bg-full" class="ipfl-bg-full"></div>
